    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.Ativar();
                user.AtribuirAcessoDiasDaSemana(DiasDaSemana.Domingo | DiasDaSemana.Segunda | DiasDaSemana.Terca | DiasDaSemana.Quarta | DiasDaSemana.Quinta | DiasDaSemana.Sexta | DiasDaSemana.Sabado);
